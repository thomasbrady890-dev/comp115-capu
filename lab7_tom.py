...
def remove_duplicates(s):
    ...
    E.g. 
    >>> remove_dulpicates("apple")
    "aple"

    Parameters:

     - s (string): The string in which duplicate characters are being removed.

    Returns:

     - new_string (string): A new string with the duplicate characters removed.
    """
    pass
...
def find_index(s, t):
    ...
    return -1
    """
    This function tells you the lowest index of (t) in the string (s).
    ...
    Parameters:
     ...
     - s (string): The string which is being traversed.

     - t (string): The character to be searched for.

    Returns:

    (integer): The lowest index of (t) in string (s), and if (t) does not appear, then it returns -1.
    """
    pass
...
def project_completion_day(day, days_to_completion):
    Completion_day = (days_week.index(day) + days_to_completion) % 7
    return str((days_week[Completion_day]))

    """
    This function takes the input of the day the project was started, and how many days it will take. 
    Which will then return the day the project will be completed.
    ...
    Parameters:
     ...
     - day (string): The day which the project will begin.

     - days_to_completion (integer): How many days the project will take to complete.

    Return:

     - (string): The day the project will be complete.
    """
    pass
...
"""
This function will parse a line of a log_string, break up its components, and recombine it inside a tuple.
...
Parameters
 - line (log_string): Line of log_string to be processed.

 Returns
 - (tuple): The components of the log_string recombined within a tuple.
...
for line in lines:
    ...
    parsed_log_list.append(result)
for entry in parsed_log_list:
    print(entry)
