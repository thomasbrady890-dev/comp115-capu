...
"""
#my draw_picture_nice function

def draw_picture_nice(t,size,repeat,amounts,color_list):
    t.speed(0)
    for i in range(len(colors)):
        t.color(colors[i])
        draw_special(t,size,repeat,amounts[i])
...
if __name__ == "__main__":
    ...
    draw_picture_nice(t,100,10,decrease_amounts,colors)
