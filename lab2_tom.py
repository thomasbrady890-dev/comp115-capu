...
day_today = int(input("Today's day number"))
days_trip = int(input("Duration of trip in days"))
                  
return_day = ((day_today + days_trip)%7)

print(f"""Your trip begins on day {day_today}, it lasts {days_trip} days, and you will return on day {return_day}.""")
